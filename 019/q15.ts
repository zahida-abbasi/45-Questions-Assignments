...
let guestList: string[] = ["zahida", "muhammad","daniyal","ali bhadur"];
...
let newGuest:string = "hammad ali";

// now we must know the index of the guest who can't make it. we use indexOf()
let indexOfguestWhoCantMakeI:number = guestList.indexOf(guestWhoCantMakeIt);
